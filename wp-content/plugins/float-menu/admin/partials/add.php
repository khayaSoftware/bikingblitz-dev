		...
		<div id="wow-rightcol">
			...
			<div class="wowbox">
				...
				<div class="wow-admin wow-plugins">
					<p><a href="https://wordpress.org/plugins/float-menu/" target="_blank">Leave your rating and review</a> on the work of the plugin and get a 30% discount on all plugins on site <span style="color: #43cb83;">https://wow-estore.com</span> <a href="admin.php?page=<?php echo $pluginname;?>&tool=pro" >More information</a> <br/><br/>
					<em>Best Regards,<br/>
